  ...
  return (
    <div>
      ...
      <div className="space-y-6">
        {pyq.isAiGenerated && (
          <div className="rounded-xl border border-indigo-200 dark:border-indigo-800 bg-indigo-50/50 dark:bg-indigo-950/30 p-3 shadow-xs">
            ...
            <p className="text-xs text-indigo-600/80 dark:text-indigo-400/80 mt-0.5 ml-4">
              Generated by {pyq.aiModel || 'NVIDIA 120B'} for practice. This is not an official UPSC previous year question.
            </p>
          </div>
        )}
